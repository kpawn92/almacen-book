    ...
    <section class="py-5 bg-light-lighten border-top border-bottom border-light">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h3>Quejas o <span class="text-primary">sugerencias</span></h3>
                    ...
                    <form id="form-comment">
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-12">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control form-control-light" type="text" name="subject" placeholder="Enter subject...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-12">
                                <div class="mb-2">
                                    ...
                                    <textarea id="comments" rows="4" name="comment" class="form-control form-control-light" placeholder="Type your message here..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-primary">Send a Message <i class="mdi mdi-telegram ms-1"></i> </button>
                            </div>
                        </div>
                    </form>
                </div>
