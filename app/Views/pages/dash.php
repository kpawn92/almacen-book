        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card widget-flat bg-primary text-white">
                <div class="card-body">
                    ...
                    <h5 class="fw-normal mt-0" title="Revenue">Estudiantes</h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card widget-flat bg-danger text-white">
                <div class="card-body">
                    ...
                    <h5 class="fw-normal mt-0" title="Revenue">P&eacute;rdidas</h5>
                    <h3 class="mt-3 mb-3 text-white">$10,245</h3>
                    <p class="mb-0">
                        <span class="badge bg-info me-1">
                            <i class="mdi mdi-arrow-up-bold"></i> 17.26%</span>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card widget-flat bg-warning text-black">
                <div class="card-body">
                    ...
                    <h5 class="fw-normal mt-0" title="Revenue">Ventas</h5>
                    <h3 class="mt-3 mb-3 text-white">$10,245</h3>
                    <p class="mb-0">
                        <span class="badge bg-info me-1">
                            <i class="mdi mdi-arrow-up-bold"></i> 17.26%</span>
